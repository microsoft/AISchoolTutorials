...
namespace SnipInsight.AIServices.AILogic
{
    ...
    internal class ContentModerationHandler
    {
        ...
        /// <summary>
        /// Minimum adult classification score 
        /// </summary>
        private const double AdultClassificationScoreMin = 0.2;
        
        /// <summary>
        /// minimum racy classification score
        /// </summary>
        private const double RacyClassificationScoreMin = 0.5;
        ...
        public ContentModerationHandler(HttpClient client=null)
        {
            contentModerationClient = client ?? new HttpClient();
            contentModerationClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", APIKeys.ContentModeratorAPIKey);   
            BuildURI();
        }
